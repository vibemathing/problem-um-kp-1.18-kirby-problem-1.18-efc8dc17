...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.18-kirby-problem-1.18-efc8dc17-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.18"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.18-kirby-problem-1.18-efc8dc17-v1",
      "problem_contract_sha256": "678eb7bff550e9741228fbc52d867ecb4aa589f358e76aa0b386b1e64fa1a70f",
      "problem_id": "problem:um-kp-1.18-kirby-problem-1.18-efc8dc17",
      "route_id": "route:um-kp-1.18-kirby-problem-1.18-efc8dc17-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.18-kirby-problem-1.18-efc8dc17-source-fidelity-01",
      "graph_id": "graph:um-kp-1.18-kirby-problem-1.18-efc8dc17-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.18-kirby-problem-1.18-efc8dc17-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.18-kirby-problem-1.18-efc8dc17-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) $($ Meridional Rank Conjecture $)$ Is the meridional $\\operatorname{rank} \\mu(L)$ of every link $L$ equal to its bridge number $b(L)$? (b) Given two knots $K_{1}, K_{2} \\subset S^{3}$ such that $\\pi_{1}(S^{3}\\setminus K_{1})$ and $\\pi_{1}(S^{3}\\setminus K_{2})$ have the same finite quotients, does $\\mu(K_{1}) = \\mu(K_{2})$? In particular, is it possible to explicitly detect the meridional $\\operatorname{rank} \\mu(K)$ of a knot $K \\subset S^{3}$ from the finite quotients of $\\pi_{1}(S^{3}\\setminus K)$? (c) Given two links $L_{1}, L_{2} \\subset S^{3}$, if there exists a surjective homomorphism $\\pi_{1}(S^{3}\\setminus L_{1}) \\twoheadrightarrow\\pi_{1}(S^{3}\\setminus L_{2})$ that sends the meridians of $L_{1}$ to the meridians of $L_{2}$, do the bridge numbers satisfy $b(L_{1}) \\geq b(L_{2})$? (d) Given two knots $K_{1}, K_{2} \\subset S^{3}$, if there exists a surjective homomorphism $\\pi_{1}(S^{3}\\setminus K_{1}) \\twoheadrightarrow\\pi_{1}(S^{3}\\setminus K_{2})$ (which may not send meridians to meridians): (i) Do the meridional ranks satisfy $\\mu(K_{1}) \\geq \\mu(K_{2})$? (ii) Do the bridge numbers satisfy $b(K_{1}) \\geq b(K_{2})$? (e) Let $K \\subset S^{3}$ be a hyperbolic knot. Is every subgroup of $\\pi_{1}(S^{3}\\setminus K)$ generated by at most $b(K) - 1$ meridians free? See [BJW18]."
          },
          "statement_sha256": "d6075d6540610ad7250c247bf7f33d6774223a8937894e0f05e1eb043be70ea5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.18-kirby-problem-1.18-efc8dc17-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.18-kirby-problem-1.18-efc8dc17-root",
      "route_id": "route:um-kp-1.18-kirby-problem-1.18-efc8dc17-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.18-41d497bfb22c",
        "url": "https://www.unsolvedmath.com/problems/KP-1.18"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
